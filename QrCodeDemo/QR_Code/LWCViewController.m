...
- (void)setZBarBorder {
    ...
    imageView.frame = CGRectMake((VIEW_WIDTH - SCAN_AREA_WIDTH)/2, TOP_HEIGHT , SCAN_AREA_WIDTH, SCAN_AREA_HEIGHT);
    ...
    UIView *TopView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, VIEW_WIDTH, TOP_HEIGHT)];
    TopView.alpha = 0.8;
    ...
    //返回按钮
    backButton = [[UIButton alloc] initWithFrame:CGRectMake(10, (BottomView.frame.size.height - 40)/2, 145, 40)];
    ...
    //开灯按钮
    LightButton = [[UIButton alloc] initWithFrame:CGRectMake(165, (BottomView.frame.size.height - 40)/2, 145, 40)];
